...
<div class="usuarios-layout">
    ...
    <div class="panel-formulario">
        ...
        <form id="form-registrar-usuario" action="{{ route('personal.store') }}" method="POST">
            @csrf
                ...
                <tr>
                    <td>
                        <div class="usuario-info">
                            <div class="usuario-avatar {{ $claseAvatar }}">{{ $iniciales }}</div>
                    ...
                    <td>
                        <span class="badge-rol {{ $claseRol }}">{{ strtoupper($usuario->role) }}</span>
                    </td>
                    <td>
                        <span class="ultima-actividad">{{ $usuario->updated_at->diffForHumans() }}</span>
                    </td>
                    <td>
                        <div class="acciones-usuario">
                            ...
                            <form action="{{ route('personal.destroy', $usuario->id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
...
<div class="modal-usuario-overlay" id="modal-editar-usuario">
    <div class="modal-usuario-container">
        ...
        <form id="form-editar-usuario" action="{{ route('personal.update', 0) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="form-usuario-group">
