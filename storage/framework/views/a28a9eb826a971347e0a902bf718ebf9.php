            ...
            <form method="POST" action="/login" id="loginForm">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="email" id="email" name="email" placeholder="usuario@dominio.com" value="<?php echo e(old('email')); ?>" required autofocus>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.login', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PostGrado\resources\views/auth/login.blade.php ENDPATH**/ ?>